...
def draw_v1():
    ...
    apps = [("微信", "#07C160", "45分钟", "💬"), ("抖音", "#FF6B6B", "32分钟", "🎵"), ("B站", "#FB7299", "28分钟", "📺")]
...
def draw_v2():
    ...
    draw.rectangle([0, 0, WIDTH, 130], fill='#FFFFFF')
    # Rounded corners at bottom only
    draw.ellipse([0, 130-30, 30, 130], fill='#FFFFFF')
    draw.ellipse([WIDTH-30, 130-30, WIDTH, 130], fill='#FFFFFF')
    ...
    draw_rounded_rect(draw, [40, y+60, 40+int((WIDTH-80)*0.62), y+80], 10, '#2E8B7A')
    ...
    apps = [("微信", "#07C160", "45分", "💬"), ("抖音", "#000000", "32分", "🎵"), ("B站", "#FB7299", "28分", "📺"), ("王者", "#FF9800", "25分", "🎮")]
    for i, (name, color, time, emoji) in enumerate(apps):
        ay = y + 30 + i * 62
...
def draw_v3():
    ...
    draw.rounded_rectangle([20, y, WIDTH-20, y+150], radius=30, outline='#FFB6C1', width=3)
    ...
    apps = [("微信", "#07C160", "45分钟", "💬", 3), ("抖音", "#FF6B6B", "32分钟", "🎵", 2), ("B站", "#FB7299", "28分钟", "📺", 2)]
...
images = [Image.open('screens_pro/v1_sakura.png'), Image.open('screens_pro/v2_mint.png'), Image.open('screens_pro/v3_candy.png')]
...
y_offset = 0
labels = [("V1 柔和樱花风", "#FFB6C1", "温柔粉系 · 圆润字体"), ("V2 清新薄荷风", "#2E8B7A", "苹果简洁 · 薄荷配色"), ("V3 活力糖果风", "#FF6B6B", "手写风格 · 趣味性强")]
...
print(f'Generated: screens_pro/ui_versions_pro.png ({total_width}x{total_height})')
